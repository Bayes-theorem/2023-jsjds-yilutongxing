...
Component({
  ...
  methods: {
    ...
    setConversationAvatar(conversation) {
      ...
      if (conversation.type === 'GROUP') {
        return conversation.groupProfile.avatar || 'cloud://cloud1-0gqi2aqh09be9468.636c-cloud1-0gqi2aqh09be9468-1309203872/static/assets/gruopavatar.svg';
      }
    },
    // 删除会话
    deleteConversation() {
    ...
    handleimageerro() {
      this.setData({
        setConversationAvatar: 'cloud://cloud1-0gqi2aqh09be9468.636c-cloud1-0gqi2aqh09be9468-1309203872/static/assets/gruopavatar.svg',
      });
    },
  },
});
